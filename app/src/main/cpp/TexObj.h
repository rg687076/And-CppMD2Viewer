...
class TexObj {
public:
    static std::tuple<bool, int, int, std::vector<char>> LoadTexture(const std::vector<char> &texbindata);

private:
    static std::tuple<int/*幅*/, int/*高さ*/, std::vector<char>/*RGBA*/> LoadTextureFromBmp(const std::vector<char> &texbindata);
    static std::tuple<int/*幅*/, int/*高さ*/, std::vector<char>/*RGBA*/> LoadTextureFromTga(const std::vector<char> &texbindata, EComponentType type);
